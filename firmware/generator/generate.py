...
# exist when the preset was written", which is otherwise indistinguishable: every
# preset stores all 256 slots, so an address that did not exist reads as a
...
with open('../include/parameter_introduction.h', 'w') as _out:
    ...
    _out.write("const uint8_t parameter_introduction[256] = {\n")
    for _i in range(0, 256, 16):
